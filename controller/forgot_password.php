	...
	if (! filter_var ( $email, FILTER_VALIDATE_EMAIL )) // Validate email address
{
		...
		if (count ( $Results ) >= 1) {
			...
			$from = 'Shagufta Naaz';
			$body = 'Hi, <br/> <br/>Your Membership ID is ' . $Results ['id'] . ' <br><br>Click here to reset your password http://localhost.myapps/SearchTeacher/views/reset_password-1.html?encrypt=' . $encrypt . '&action=reset   <br/> <br/>--<br>';
